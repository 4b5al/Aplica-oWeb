...
import br.com.controle.calcSemestre;
...
public class ServletSemestre extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            double n4 = Double.valueOf(request.getParameter("nota4"));
            
            calcSemestre cs = new calcSemestre();
            ...
            request.setAttribute("res", cs.resultado());
